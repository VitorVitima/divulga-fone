...
function Divulgar(){
    ...
    function subButton(e){
        ...
        axios.post('divulga-back-dcbzuzcjn-vitorvitima.vercel.app/register', {
    ...
    return(
        <section id='sForm'>
            <h1>Divulgar</h1>
            <form action='divulga-back-dcbzuzcjn-vitorvitima.vercel.app/register' autoComplete={'off'} id='form-api' method='post' enctype='multipart/form-data'>
                <div id='nome'>
